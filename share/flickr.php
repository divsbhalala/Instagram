...
$_SESSION['wallflickr']='http://'.$_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"];
            ...
            <div class="container " style="margin-top: 80px; " >
                ...
                <div class="row" style="<?php echo $btnlogin; ?>">
                    <div class="col-md-12 text-center">
                        <button class="btn btn-social btn-flickr" ><i class="fa fa-flickr"></i> Login With Flickr</button>
                    </div>
                    
                </div>
                <socialshare class="hidden">flickr</socialshare>
