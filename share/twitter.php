            ...
            <div class="container " style="margin-top: 80px; " >
                ...
                <div class="row" style="<?php echo $btnlogin; ?>">
                    <div class="col-md-12 text-center">
                        <a href="http://sociallabels.imnwebhosting.com/pages/tlogin.php" class="btn btn-social btn-twitter"><i class="fa fa-twitter"></i> Login With Twitter</a>
                    </div>
                    
                </div>
                <socialshare class="hidden">twitter</socialshare>
