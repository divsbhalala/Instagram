...
class Instagram
{
    ...
    public function getUserMedia($id = 'self', $limit = 0)
    {
      ...
      public function updateMedia($photos,$desc='Photo Using My Test')
    {
          $a = time();
          $post = array("device_timestamp" => $a, "lat" => 0, "lng" => 0, "photo" => $photos);
        return $this->_makeCall('media/upload/', true,$post,'POST');
    }
