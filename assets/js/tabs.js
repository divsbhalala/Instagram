...
$(document).ready(function () {
    ...
    function showmedia() {
        ...
        for (var i = 0; i < fbphotos.length; i++)
        {
            ...
            str = ' <div class="col-lg-3 col-md-4 col-xs-6 box ">' +
                    '<div class="lab">' +
                    '</div>' +
                    '<a class="thumbnail getImg " title="Click me to See more" href="photos.php" data-imgsrc="' + fbphotos[i].source + '">' +
    ...
    function getflickrphotos() {
        $.get("http://sociallabels.imnwebhosting.com/pages/getflickrphotos.php", function (data) {
            console.log(data);
            if (data.length > 0)
            {
                ...
                for (var i = 0; i < data.length; i++)
                {
                    ...
                    str = ' <div class="col-lg-3 col-md-4 col-xs-6 box ">' +
                            '<div class="lab">' +
                            '</div>' +
                            '<a class="thumbnail getImg " title="Click me to See more" href="photos.php" data-imgsrc="' + data[i].url + '">' +
    ...
    function getinstagramphotos() {
        $.get("http://sociallabels.imnwebhosting.com/pages/getinstagramphotos.php", function (data) {
            console.log(data);
            if (data.hasOwnProperty('data'))
            {
                 ...
                 for (var i = 0; i < photodata.length; i++)
                {
                    ...
                    str = ' <div class="col-lg-3 col-md-4 col-xs-6 box ">' +
                            '<div class="lab">' +
                            '</div>' +
                            '<a class="thumbnail getImg " title="Click me to See more" href="photos.php" data-imgsrc="' + photodata[i].images.standard_resolution.url + '">' +
