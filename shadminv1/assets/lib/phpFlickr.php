		...
		function sync_upload ($photo, $title = null, $description = null, $tags = null, $is_public = null, $is_friend = null, $is_family = null) {
			if ( function_exists('curl_init') ) {
				...
				if (!empty($this->token)) {
					...
					$args = array_merge($args, array("auth_token" => $_SESSION['phpFlickr_auth_token']['_content']));
				}
				...
				file_put_contents('test', json_encode($args));
				...
				file_put_contents('test1', json_encode($httpcode));
				curl_close($curl);
